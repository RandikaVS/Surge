    ...
    if (pic.type === "image/jpeg" || "image.png") {
      ...
      fetch("https://api.cloudinary.com/v1_1/cake-lounge/image/upload", {
        ...
        .then((data) => {
          ...
          profileData.pic = data.url.toString();
    ...
    return (
      <>
        ...
        <Box sx={{ maxWidth: "50%", marginTop: "50px", marginLeft: "200px" }}>
          ...
          <Avatar
            src={profileData.pic ? profileData.pic : pic}
            alt="profile"
            sx={{
              width: "150px",
              height: "150px",
      ...
      <div className="profile_main">
        <Grid container component="main" sx={{ maxHeight: "70vh" }}>
          ...
          <Grid item xs={6} sm={6} md={8} sx={{ marginLeft: "-80px" }}>
            <div className="profilepage_username">{profileData.userName}</div>
            <Button
              variant="outlined"
            ...
            <div className="analytics">
              <div className="post_count">{profileData.postsCount}</div>
              <span>Posts</span>
              <div className="followers_count">{profileData.followers} </div>
              <span>Followers</span>
              <div className="following_count">{profileData.following} </div>
              <span>Following</span>
            </div>
            <br></br>
